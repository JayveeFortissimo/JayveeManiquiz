    ...
    <div className="min-h-[10rem]  flex items-center flex-col px-2">
      <header className="container mx-auto max-w-[50rem]  flex items-center gap-3 sm:gap-5">
        <Image
          ...
          width={150}
          height={80}
          className="rounded h-auto w-[8rem] sm:w-[10rem] cursor-pointer"
        />
        <div className="w-full">
          ...
          <div className="flex items-center gap-1 mt-[0.1rem]">
            <MapPin size={15} />
            <p className="text-[0.7rem] md:text-[0.9rem]">{location}</p>
          </div>
          <h1 className="text-[0.9rem]  md:text-[1rem] mt-2">{profession}</h1>
          <footer className="mt-2 flex items-center gap-3 w-full pr-3">
            <Button
              className="h-[1.8rem] md:h-[1.8rem] bg-blue-500 cursor-pointer flex-auto  text-white  "
              onClick={() =>
